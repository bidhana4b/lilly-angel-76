      ...
      <div className="container mx-auto px-6 flex items-center justify-between py-3">
        <Link to="/" className="flex items-center space-x-2">
          <motion.img
            ...
            fetchPriority="high"
          />
          <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-navy-light to-navy-dark">
            Lilly-Angel
          </span>
        </Link>
              ...
              <NavigationMenuContent className="bg-white p-4 rounded-lg shadow-lg border border-gray-100 min-w-[200px]">
                <ul className="grid gap-2">
                  <li>
                    <Link 
                      to="/about" 
                      className="block p-2 rounded-md hover:bg-orange-100 transition-colors text-gray-700 hover:text-orange-600"
            ...
            <NavigationMenuItem>
              <Link to="/social-responsibility">
                <NavigationMenuLink 
                  className={cn(
                    "group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-all hover:bg-gradient-to-r hover:from-orange-400 hover:to-orange-500 hover:text-white hover:shadow-md hover:scale-105",
                    isActive('/social-responsibility') 
                      ? "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-md" 
                      : "text-gray-700"
                  )}
                >
          ...
          <SheetContent side="right" className="w-[300px] bg-gradient-to-b from-white to-orange-50">
            ...
            <nav className="flex flex-col gap-4 mt-6">
              ...
              <div className="flex flex-col">
                ...
                <Link
                  to="/about/team"
                  className={`text-md font-medium p-2 pl-6 rounded-md transition-colors ${
                    isActive('/about/team')
                      ? 'text-orange-500 bg-orange-50'
                      : 'text-gray-600 hover:text-orange-500 hover:bg-orange-50'
                  }`}
