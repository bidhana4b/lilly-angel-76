      ...
      <div className="container mx-auto relative z-10 px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            {/* Main Heading */}
            <motion.h1 
              className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-navy-dark via-navy-DEFAULT to-navy-light"
            ...
            >
              {[
                { icon: <BookOpen className="h-4 w-4 text-orange-500" />, text: "Expert-Led Courses" },
                { icon: <Award className="h-4 w-4 text-orange-500" />, text: "Accredited Certifications" },
                { icon: <CheckCircle className="h-4 w-4 text-orange-500" />, text: "Industry Recognized" },
              ].map((item, index) => (
                <div 
                  key={index} 
                  className="flex items-center bg-white/70 backdrop-blur-sm px-3 py-1.5 rounded-full text-sm font-medium text-gray-700 shadow-sm border border-gray-100"
                >
                  {item.icon}
            ...
            >
              <Button className="bg-orange-DEFAULT hover:bg-orange-dark px-6 py-2.5 text-white font-medium text-base shadow-xl hover:shadow-orange-500/20 transition-all duration-300 transform hover:-translate-y-1 group">
                Find Your Courses
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform duration-300" />
              </Button>
              
              <Button variant="outline" className="border-2 border-navy-light bg-white/50 hover:bg-white text-navy-dark px-6 py-2.5 font-medium text-base transition-all duration-300 transform hover:-translate-y-1">
                Explore Programs
              </Button>
            </motion.div>
          </motion.div>
